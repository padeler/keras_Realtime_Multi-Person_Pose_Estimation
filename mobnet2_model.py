...
from mobilenets import _depthwise_conv_block_v2
...
def vnect_dwc_block1(input, alpha=1.0, depth_multiplier=1):
    ...
    x = _depthwise_conv_block(x, 512, alpha, depth_multiplier, block_id=14)
...
def vnect_dwc_block2(x, num_p, alpha=1.0, depth_multiplier=1):
    ...
    # final conv portion.
    x = _depthwise_conv_block(x, 128, alpha, depth_multiplier, block_id=16)
